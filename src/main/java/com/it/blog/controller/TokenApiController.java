...
import com.it.blog.dto.CreatedAccessTokenResponse;
...
public class TokenApiController {
    ...
    @PostMapping
    public ResponseEntity<CreatedAccessTokenResponse> createNewAccessToken(@RequestBody CreateAccessTokenRequest request){
